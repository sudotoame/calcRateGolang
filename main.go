...
func main() {
	...
	for {
		...
		result := calculateRate(&rates, quantityCurrency, firstCurrency, lastCurrency)
...
func calculateRate(rates *map[string]float64, number float64, from, to string) float64 {
